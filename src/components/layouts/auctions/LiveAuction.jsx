    ...
    <div className="fl-item col-xl-3 col-lg-6 col-md-6">
        <div className="sc-card-product">
            <div className="card-media">
                {props.item.img && <Link to="/item-details-01"><img src={props.item.img} alt="hulula" /></Link>}
            ...
            <div className="meta-info">
                <div className="author">
                    <div className="avatar">
                        {props.item.imgAuthor && <img src={props.item.imgAuthor} alt="hulula" />}
                    </div>
                    <div className="info">
                        <span>Creator</span>
                        <h6> <Link to="#">{props.item.nameAuthor}
                        </Link> </h6>
                    </div>
                </div>
                <div className="price">
